...
const Dashborard = () => {
     ...
     const [dashboard , setdashborardata] = useState({
        totalBookings : 0, 
         totalRevenue : 0,
         activeShows : [],
         totalUser : 0
     ...
     const fetchdashboraddata = async () => {
      ...
      setdashborardata(dummyDashboardData);
      setLoading(false);
     }
  ...
  return !loading ? (
    ...
    <>
       <Tilte text1="Admin" text2="Dashboard"/>
             ...
             {dashboardCards.map((card, index)=> (
              ...
              >
                <div>
                   ...
                   <p className='text-xl fond-medium mt-1'>{card.value}</p>
                </div>
       ...
       <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
        ...
        {dashboard.activeShows.map((show) => (
          ...
          >
            ...
            <p
            className='px-2 pt-1 text-sm text-gray-500'
